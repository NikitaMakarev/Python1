...
#Тестирование БД на тестовых данных test_data
    ...
    test_data =[{'contact_id': 1, 'surname': 'Иванов', 'name': 'Иван', 'phone': '111', 'comment': 'Друг'}, 
                ...
                {'contact_id': 3, 'surname': 'Сидоров', 'name': 'Максим', 'phone': '333', 'comment': 'Должен 1000'},
    ...
    test_contact_edit = {'contact_id': 3, 'surname': 'Сидоров', 'name': 'Максим', 'phone': '333', 'comment': 'Должен 7777'}
